...
import { Product } from '../lib/types'; // Ajusta la ruta a donde tengas tu interfaz Product
  ...
  return (
    <div className="space-y-3">
      ...
      <button 
        ...
        className="w-full bg-black text-white py-4 px-6 rounded-lg font-bold text-lg hover:bg-gray-800 transition-colors shadow-sm"
      >
        Agregar al carrito
      </button>
    </div>
